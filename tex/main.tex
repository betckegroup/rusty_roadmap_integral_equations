...
\item Big fan of anything Scientific Computing, Rust, and Python
\item Not coming from an AI background but big interest in building modern integrated computational ecosystems
\end{itemize}
\end{frame}
...
\begin{frame}
\frametitle{Also talk to me about...}


\begin{minipage}{5cm}
\begin{itemize}
\item Planned Centre for Doctoral Training (joint UCL/Imperial) on the interface of
research software engineering, computational sciences, and data sciences.
\item Planned UKRI Hub for Numerical Analysis Foundations of Artificial Intelligence.
\end{itemize}
\end{minipage}
\begin{minipage}{5cm}
\includegraphics[width=5cm]{../figs/bentham}
\end{minipage}
